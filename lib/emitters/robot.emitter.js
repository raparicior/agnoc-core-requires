...
let Robot = (_class = class Robot extends _tinyTypedEmitter.TypedEmitter {
  ...
  async start() {
    ...
    await this.setMode(setModeOption());
...
function setModeOption() {
  var _this$device$operatio, _this$device$operatio2, _this$device$operatio3;
  if (((_this$device$operatio = this.device.operationMode) === null || _this$device$operatio === void 0 ? void 0 : _this$device$operatio.value) !== _deviceOperationMode.DeviceOperationMode.VALUE.DEFAULT) {
    var _this$device$mode10, _this$device$mode11;
    if (this.device.hasMopAttached && ((_this$device$mode10 = this.device.mode) === null || _this$device$mode10 === void 0 ? void 0 : _this$device$mode10.value) !== _deviceMode2.DeviceMode.VALUE.MOP) {
      return new _deviceMode2.DeviceMode({
        value: _deviceMode2.DeviceMode.VALUE.MOP
      });
    } else if (!this.device.hasMopAttached && ((_this$device$mode11 = this.device.mode) === null || _this$device$mode11 === void 0 ? void 0 : _this$device$mode11.value) === _deviceMode2.DeviceMode.VALUE.MOP) {
      return new _deviceMode2.DeviceMode({
