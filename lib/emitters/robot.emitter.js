...
let Robot = (_class = class Robot extends _tinyTypedEmitter.TypedEmitter {
  ...
  async start() {
    var _this$device$mode, _this$device$mode2, _this$device$mode3, _this$device$map;
    await this.setMode(setModeOption(this.device));
    if (((_this$device$mode = this.device.mode) === null || _this$device$mode === void 0 ? void 0 : _this$device$mode.value) === _deviceMode2.DeviceMode.VALUE.ZONE) {
      await this.sendRecv('DEVICE_AREA_CLEAN_REQ', 'DEVICE_AREA_CLEAN_RSP', {
        ctrlValue: CTRL_VALUE.START
      });
    } else if (((_this$device$mode2 = this.device.mode) === null || _this$device$mode2 === void 0 ? void 0 : _this$device$mode2.value) === _deviceMode2.DeviceMode.VALUE.MOP) {
      await this.sendRecv('DEVICE_MOP_FLOOR_CLEAN_REQ', 'DEVICE_MOP_FLOOR_CLEAN_RSP', {
        ctrlValue: CTRL_VALUE.START
      });
    } else if (((_this$device$mode3 = this.device.mode) === null || _this$device$mode3 === void 0 ? void 0 : _this$device$mode3.value) === _deviceMode2.DeviceMode.VALUE.SPOT && (_this$device$map = this.device.map) !== null && _this$device$map !== void 0 && _this$device$map.currentSpot) {
  ...
  async pause() {
    var _this$device$mode4, _this$device$mode5, _this$device$mode6, _this$device$map2;
    if (((_this$device$mode4 = this.device.mode) === null || _this$device$mode4 === void 0 ? void 0 : _this$device$mode4.value) === _deviceMode2.DeviceMode.VALUE.ZONE) {
      await this.sendRecv('DEVICE_AREA_CLEAN_REQ', 'DEVICE_AREA_CLEAN_RSP', {
        ctrlValue: CTRL_VALUE.PAUSE
      });
    } else if (((_this$device$mode5 = this.device.mode) === null || _this$device$mode5 === void 0 ? void 0 : _this$device$mode5.value) === _deviceMode2.DeviceMode.VALUE.MOP) {
      await this.sendRecv('DEVICE_MOP_FLOOR_CLEAN_REQ', 'DEVICE_MOP_FLOOR_CLEAN_RSP', {
        ctrlValue: CTRL_VALUE.PAUSE
      });
    } else if (((_this$device$mode6 = this.device.mode) === null || _this$device$mode6 === void 0 ? void 0 : _this$device$mode6.value) === _deviceMode2.DeviceMode.VALUE.SPOT && (_this$device$map2 = this.device.map) !== null && _this$device$map2 !== void 0 && _this$device$map2.currentSpot) {
      await this.sendRecv('DEVICE_MAPID_SET_NAVIGATION_REQ', 'DEVICE_MAPID_SET_NAVIGATION_RSP', {
        mapHeadId: this.device.map.id.value,
        poseX: this.device.map.currentSpot.x,
        poseY: this.device.map.currentSpot.y,
  ...
  async setMode(mode) {
    ...
    await (0, _waitFor.waitFor)(() => {
      var _this$device$mode7;
      return ((_this$device$mode7 = this.device.mode) === null || _this$device$mode7 === void 0 ? void 0 : _this$device$mode7.value) === mode.value;
    }, {
  ...
  async cleanPosition(position) {
    var _this$device$mode8;
    if (!this.device.map) {
      throw new _domain.DomainException('Unable to set robot position: map not loaded');
    }
    if (((_this$device$mode8 = this.device.mode) === null || _this$device$mode8 === void 0 ? void 0 : _this$device$mode8.value) !== _deviceMode2.DeviceMode.VALUE.SPOT) {
  ...
  async cleanAreas(areas) {
    ...
    if (((_this$device$mode9 = this.device.mode) === null || _this$device$mode9 === void 0 ? void 0 : _this$device$mode9.value) !== _deviceMode2.DeviceMode.VALUE.ZONE) {
      await this.setMode(new _deviceMode2.DeviceMode({
...
exports.Robot = Robot;
function setModeOption(device) {
  var _device$operationMode, _device$operationMode2, _device$mode, _device$mode2;
  if (((_device$operationMode = device.operationMode) === null || _device$operationMode === void 0 ? void 0 : _device$operationMode.value) == _deviceOperationMode.DeviceOperationMode.VALUE.MOP) {
    return new _deviceMode2.DeviceMode({
      value: _deviceMode2.DeviceMode.VALUE.MOP
    });
  } else if (((_device$operationMode2 = device.operationMode) === null || _device$operationMode2 === void 0 ? void 0 : _device$operationMode2.value) == _deviceOperationMode.DeviceOperationMode.VALUE.VACUUM) {
    return new _deviceMode2.DeviceMode({
      value: _deviceMode2.DeviceMode.VALUE.NONE
    });
  } else if (device.hasMopAttached && ((_device$mode = device.mode) === null || _device$mode === void 0 ? void 0 : _device$mode.value) !== _deviceMode2.DeviceMode.VALUE.MOP) {
    return new _deviceMode2.DeviceMode({
      value: _deviceMode2.DeviceMode.VALUE.MOP
    });
  } else if (!device.hasMopAttached && ((_device$mode2 = device.mode) === null || _device$mode2 === void 0 ? void 0 : _device$mode2.value) === _deviceMode2.DeviceMode.VALUE.MOP) {
    return new _deviceMode2.DeviceMode({
      value: _deviceMode2.DeviceMode.VALUE.NONE
    });
  }
